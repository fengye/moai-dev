...
/**	@name	getApplicationState
	@text	Get the UIApplication.applicationState value
 
	@in	nil
	@out	num applicationState
 */
int MOAIAppIOS::_getApplicationState ( lua_State* L ) {
	
	MOAILuaState state ( L );
	
	lua_pushnumber ( state, MOAIAppIOS::Get ().mApplication.applicationState );
...
void MOAIAppIOS::RegisterLuaClass ( MOAILuaState& state ) {
	...
	luaL_Reg regTable [] = {
		{ "getApplicationState",		_getApplicationState },
