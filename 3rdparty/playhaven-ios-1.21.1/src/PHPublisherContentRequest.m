...
@synthesize overlayWindowBackgroundColor = _overlayWindowBackgroundColor;
...
- (UIView *)overlayWindow
{
    if (_overlayWindow == nil) {
        ...
        _overlayWindow.backgroundColor = _overlayWindowBackgroundColor?_overlayWindowBackgroundColor:[UIColor colorWithWhite:0 alpha:0.5];

		UIActivityIndicatorView *spinner = [[UIActivityIndicatorView alloc]
			initWithFrame:CGRectMake(0.0f, 0.0f, 18.0, 18.0f)];
		[spinner setActivityIndicatorViewStyle:UIActivityIndicatorViewStyleGray];
		spinner.center = _overlayWindow.center;
		[_overlayWindow addSubview:spinner];
...
- (void)dealloc
{
    ...
    [_overlayWindowBackgroundColor release], overlayWindowBackgroundColor = nil;
